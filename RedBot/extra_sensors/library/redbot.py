...
class RedBotSensor:
    ...
    def __init__(self, board, pin_number, value_changed_callback=None):
        self.board = board
        self.pin_number = pin_number
        board.set_pin_mode(pin_number, Constants.ANALOG, callback=value_changed_callback, cb_type=Constants.CB_TYPE_DIRECT)
