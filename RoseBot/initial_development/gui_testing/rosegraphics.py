...
class Text(_ShapeWithCenter, _ShapeWithText):
    ...
    Its constructor specifies the m4.Point at which the text
    is centered and the string that is to be displayed.

    Public data attributes: center (an m4.Point),
